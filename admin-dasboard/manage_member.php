            ...
            <div class="content">
                ...
                <table>
                    ...
                    <tbody>
                        <?php
                        try {
                            $sql = "SELECT * FROM tbl_member WHERE role = 'user'";
                            $stmt = $conn->query($sql);
                            ...
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                echo "<td>{$row['role']}</td>";
                                echo "<td>
                                    <a href='backend/edit_member.php?id={$row['member_id']}'>Edit</a> |
                                    <a href='backend/delete_member.php?id={$row['member_id']}' onclick='return confirm(\"Are you sure?\")'>Delete</a>
                                </td>";
                                echo "</tr>";
                            }
