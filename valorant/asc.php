...
<html lang="en">
	<head>
		...
		<title>Valorant | Ascendant</title>
							...
							<div class="row">
								<div class="col-sm-6 col-md-4">
									<div class="product-images">
										...
										<img src="../images/Ascendant_3_Rank.png" alt="Game 7">
										</figure>
										
									</div>
								</div>
								<div class="col-sm-6 col-md-8">
									<h2 class="entry-title">บูสแรงก์ Ascendant ขั้นละ 290</h2>
									<small class="price">290 THB</small>
									...
									<form action="../backend-index/saveorder.php" method="post" enctype="multipart/form-data">
											...
											<input type="text" name="Rank valo" value="Boost Rank Ascendant" placeholder="Boost Rank Ascendant" readonly>
										
											<select name="Work_detail" onchange="totalbronze(this.value)">
												<option value="">เลือกระดับที่ต้องการ</option>
												<option value="1">Ascendant1-Ascendant2</option>
												<option value="1">Ascendant2-Ascendant3</option>
												<option value="3">Ascendant1-Ascendant3</option>
											</select>
											<br><br>
											...
											<input type="text" id="total" name="price" readonly>&nbsp;บาท <br>
												...
												<div class="form-group">
											<input type="submit" value="ซื้อเลย" id="buy" name="AscBuy">
											   </div>
										</form>
										<script>
