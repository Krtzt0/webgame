							...
							<div class="row">
								<div class="col-sm-6 col-md-4">
									<div class="product-images">
										...
										<img src="../images/Bronze_3_Rank.png" alt="Game 2">
										</figure>
										
									</div>
								</div>
								<div class="col-sm-6 col-md-8">
									<h1 class="entry-title">บูสแรงก์ Bronze ขั้นละ 35</h1>
									<small class="price">35 THB</small>
									...
									<form action="../backend-index/saveorder.php" method="post" enctype="multipart/form-data">
											...
											<input type="text" name="Rank valo" value="Boost Rank Bronze" placeholder="Boost Rank Bronze" readonly>
										
											<select name="Work_detail" onchange="totalbronze(this.value)">
												<option value="">เลือกระดับที่ต้องการ</option>
												<option value="1">Bronze1-Bronze2</option>
												<option value="1">Bronze2-Bronze3</option>
												<option value="3">Bronze1-Bronze3</option>
											</select>
											<br><br>
											...
											<input type="text" id="total" name="price" readonly>&nbsp;บาท <br>
												...
												<div class="form-group">
											<input type="submit" value="ซื้อเลย" id="buy" name="BronzeBuy">
											   </div>
										</form>
										<script>
