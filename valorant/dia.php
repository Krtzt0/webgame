							...
							<div class="row">
								<div class="col-sm-6 col-md-4">
									<div class="product-images">
										...
										<img src="../images/Diamond_3_Rank.png" alt="Game 6">
										</figure>
										
									</div>
								</div>
								<div class="col-sm-6 col-md-8">
									<h2 class="entry-title">บูสแรงก์ Diamond ขั้นละ 200</h2>
									<small class="price">200 THB</small>
									...
									<form action="../backend-index/saveorder.php" method="post" enctype="multipart/form-data">
											...
											<input type="text" name="Rank valo" value="Boost Rank Diamond" placeholder="Boost Rank Diamond" readonly>
										
											<select name="Work_detail" onchange="totalbronze(this.value)">
												<option value="">เลือกระดับที่ต้องการ</option>
												<option value="1">Diamond1-Diamond2</option>
												<option value="1">Diamond2-Diamond3</option>
												<option value="3">Diamond1-Diamond3</option>
											</select>
											<br><br>
											...
											<input type="text" id="total" name="price" readonly>&nbsp;บาท <br>
												...
												<div class="form-group">
											<input type="submit" value="ซื้อเลย" id="buy" name="DiaBuy">
											   </div>
										</form>
										<script>
