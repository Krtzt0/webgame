							...
							<div class="row">
								<div class="col-sm-6 col-md-4">
									<div class="product-images">
										...
										<img src="../images/Silver_3_Rank.png" alt="Game 1">
										</figure>
										
									</div>
								</div>
								<div class="col-sm-6 col-md-8">
									<h2 class="entry-title">บูสแรงก์ Silver ขั้นละ 50</h2>
									<small class="price">50 THB</small>
									...
									<form action="../backend-index/saveorder.php" method="post" enctype="multipart/form-data">
											...
											<input type="text" name="Rank valo" value="Boost Rank Silver" placeholder="Boost Rank Silver" readonly>
										
											<select name="Work_detail" onchange="totalbronze(this.value)">
												<option value="">เลือกระดับที่ต้องการ</option>
												<option value="1">Silver1-Silver2</option>
												<option value="1">Silver2-Silver3</option>
												<option value="3">Silver1-Silver3</option>
											</select>
											<br><br>
											...
											<input type="text" id="total" name="price" readonly>&nbsp;บาท <br>
												...
												<div class="form-group">
											<input type="submit" value="ซื้อเลย" id="buy" name="SilBuy">
											   </div>
										</form>
										<script>
