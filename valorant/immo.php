							...
							<div class="row">
								<div class="col-sm-6 col-md-4">
									<div class="product-images">
										...
										<img src="../images/Immortal_3_Rank.png" alt="Game 8">
										</figure>
										
									</div>
								</div>
								<div class="col-sm-6 col-md-8">
									<h2 class="entry-title">บูสแรงก์ Immotal ขั้นละ 400</h2>
									<small class="price">400 THB</small>

									
									<div class="addtocart-bar">
									<form action="../backend-index/saveorder.php" method="post" enctype="multipart/form-data">
											<h2><b>กรอกรายละเอียดข้อมูล</b></h2>
											<input type="text" name="Rank valo" value="Boost Rank Immotal" placeholder="Boost Rank Immotal" readonly>
										
											<select name="Work_detail" onchange="totalbronze(this.value)">
												<option value="">เลือกระดับที่ต้องการ</option>
												<option value="1">Immotal1-Immotal2</option>
												<option value="1">Immotal2-Immotal3</option>
												<option value="3">Immotal1-Immotal3</option>
											</select>
											<br><br>
											...
											<input type="text" id="total" name="price" readonly>&nbsp;บาท <br>
												...
												<div class="form-group">
											<input type="submit" value="ซื้อเลย" id="buy" name="ImmoBuy">
											   </div>
										</form>
										<script>
