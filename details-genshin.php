                ...
                <div class="entry-content">
                    <div class="row" style="display: flex; flex-wrap: wrap;">
                        ...
                        <div class="col-sm-6 col-md-8" style="flex: 2; min-width: 300px; padding: 10px;">
                            <div class="addtocart-bar">
                                <form action="backend-index/saveorder-genshin.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">    
                                        <input type="text" id="total" name="price"value="<?php echo htmlspecialchars($_GET['game_product_price']); ?>" readonly>&nbsp;บาท <br>
                                    </div>
                                ...
                                <button class="show-image-btn" onclick="showImage()">จ่ายเงินกดตรงนี้เลย</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="workers-container" class="container-workers">
                        ...
                        $sql = "SELECT member_id, username, member_name, member_sur, worker_rank, game_details_id, member_img, member_idcard 
                                FROM tbl_member 
                                WHERE role = 'worker' AND game_details_id = 2";
